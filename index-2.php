        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4 blog latest-blog">
                    <div class="row m0 blogInner">
                        <div class="row m0 blogDateTime">
                            <i class="fa fa-calendar"></i> 18 November 2017, 11:50 AM
                        </div>
                        ...
                        <div class="row m0 postExcerpts">
                            <div class="row m0 postExcerptInner">
                                <a href="single-post.php" class="postTitle row m0"><h4>Faceted Search Has Landed</h4></a>
                                <p>This year in our 2017 roadmap one of our goals was to improve financial tooling for authors. A big part of that is the withdrawal cycle.</p>
                ...
                <div class="col-sm-4 blog latest-blog">
                    <div class="row m0 blogInner">
                        <div class="row m0 blogDateTime">
                            <i class="fa fa-calendar"></i> 16 November 2017, 12:20 AM
                        </div>
                        <div class="row m0 featureImg">
                            <a href="single-post.php">
                        ...
                        <div class="row m0 postExcerpts">
                            <div class="row m0 postExcerptInner">
                                <a href="single-post.php" class="postTitle row m0"><h4>Vat and Global Marketplace</h4></a>
                                <p>This year in our 2017 roadmap one of our goals was to improve financial tooling for authors. A big part of that is the withdrawal cycle.</p>
                                <a href="single-post.php" class="readMore">read more</a>
                            </div>
                        </div>
                ...
                <div class="col-sm-4 blog latest-blog">
                    <div class="row m0 blogInner">
                        ...
                        <div class="row m0 postExcerpts">
                            <div class="row m0 postExcerptInner">
                                <a href="single-post.php" class="postTitle row m0"><h4>Default withdrawal option</h4></a>
                                <p>This year in our 2017 roadmap one of our goals was to improve financial tooling for authors. A big part of that is the withdrawal cycle.</p>
                                <a href="single-post.php" class="readMore">read more</a>
                            </div>
                        </div>

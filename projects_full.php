    ...
    <section id="projectsRow" class="row fullWidth page">
        <div class="row filtersRow m0">
            ...
            <ul class="list-inline text-center collapse navbar-collapse filters" id="filters">
                ...
                <!-- <li data-filter=".catHospital">Hospitals</li>
                <li data-filter=".catSchools">Schools</li>
                <li data-filter=".catHouses">Houses</li>
                <li data-filter=".catFlats">Flats</li>
                <li data-filter=".catOffices">Offices</li>
                <li data-filter=".catUniversities">Universities</li> -->
            </ul>
        </div>
